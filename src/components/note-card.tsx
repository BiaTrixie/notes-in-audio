...
return(
  ...
  <p className='text-sm leading-6 text-slate-400'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Sint deserunt nostrumditiis ut recusandae ullam asperiores necessitatibus similique a aliqillo.</p>
